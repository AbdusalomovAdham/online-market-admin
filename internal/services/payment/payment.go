...
func (s *Service) Create(ctx context.Context, paymentStatus Create, authHeader string) (int64, error) {
...
func (uc *Service) Delete(ctx context.Context, paymentStatusId int64, authHeader string) error {
...
func (uc *Service) GetById(ctx context.Context, id int64) (PaymentStatusById, error) {
